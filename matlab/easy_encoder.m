function easy_encoder()
   ...
   lumMat = [
    ...
    save('compressed_img.mat', 'compressed_img');
     figure(5); imshow(compressed_img(:,:,1));
     figure(6); imshow(compressed_img(:,:,2));
     figure(7); imshow(compressed_img(:,:,3));
    ...
    grid on;
    figure(4); imshow(compressed_img);
...
%     figure(5); imshow(decompressed_img(:,:,1));
%     figure(6); imshow(decompressed_img(:,:,2));
%     figure(7); imshow(decompressed_img(:,:,3));
    ...
    figure(8); imshow(decompressed_img);
    img = imread('sample2.bmp');
    figure(9); imshow(img);
end